...
<div class="group-content">
    <h2 class="title"><?php echo __('Video Sources', 'ap-background'); ?></h2>
    <div class="content">
...
<div class="group-content video">
    <h2 class="title"><?php echo __('Video Gallery', 'ap-background'); ?><span class="bt-ajax-loading add-item-ajax"><i class="fa fa-circle-o-notch fa-spin"></i></span></h2>
    <div class="content">
            ...
            <?php if (isset($item->settings->media_source->items)): ?>
                ...
                foreach ($item->settings->media_source->items as $media_item):
                    ...
                    <div class="media-item">
                        ...
                        <img width="130" src="<?php echo esc_url_raw($media_item->large); ?>"  alt="<?php echo __('Thumbnail image','ap-background');?>"/>
                        <?php else: ?>
    ...
    <input type="hidden" id="ap_background_google_api" name="ap_background_google_api" value="<?php echo esc_attr(get_option('ap_background_google_api')); ?>"/>
</div>
    ...
    <div class="bg-type-list-wrap">
        <div class="get-from-wrap youtube" style="display: none;">
            ...
            <div class="control-group">
                <div class="label"><?php echo __('Google API', 'ap-background'); ?></div>
                <div class="control">
                    <input id="media_source_google_api" name="media_source_google_api" value="<?php echo esc_attr(get_option('ap_background_google_api')); ?>" type="text"/>
                </div>
                <div style="clear: both"></div>
            </div>
            <div class="control-group">
        ...
        <div class="get-from-wrap vimeo" style="display: none;">
            ...
            <div class="control-group">
                ...
                <div style="clear: both"></div>
                <div class="descript"><?php echo __('We are support three vimeo url format: <br/> - Single video: https://vimeo.com/56974406<br/> - Album: https://vimeo.com/album/2210627<br/> - User: https://vimeo.com/user15700123', 'ap-background'); ?></div>
            </div>
        </div>
        <div class="get-from-wrap embedcode" style="display: none;">
            <div class="header-title"><?php echo __('GET VIDEO WITH EMBED CODE', 'ap-background'); ?></div>
            <div class="control-group">
        ...
        <div class="create-slideshow">
            <span class="button blue get-video"><?php echo __('GET VIDEO', 'ap-background'); ?></span>
        </div>
    </div>
</div>
 <script>
